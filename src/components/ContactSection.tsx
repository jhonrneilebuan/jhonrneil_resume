...
const ContactSection = () => {
  ...
  const contactInfo = [
    ...
    // },
    {
      icon: Mail,
      label: "Email",
      value: "jhonrneilebuan@gmail.com",
    ...
    <section id="contact" className="py-16 md:py-24 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div
            ref={cardsRef}
            className="grid sm:grid-cols-2 gap-4 md:gap-6 mb-8 md:mb-12 max-w-2xl mx-auto"
          >
            {contactInfo.map((info, index) => (
              ...
              >
                ...
                <div
                  className={`absolute inset-0 bg-gradient-to-br ${info.color} rounded-2xl md:rounded-3xl opacity-0 group-hover:opacity-100 transition-opacity duration-500`}
                />
                ...
                <div className="relative z-10">
                  ...
                  <h3 className="font-semibold mb-1.5 md:mb-2 text-base md:text-lg">
                    {info.label}
                  </h3>
                  {info.href ? (
                    <a
            ...
            <div className="relative z-10">
              ...
              <div className="flex flex-col sm:flex-row gap-3 md:gap-4 justify-center">
                <Button
                  asChild
                  size="lg"
                  className="bg-gradient-primary text-primary-foreground hover:opacity-90 glow-primary px-6 md:px-8 rounded-full text-sm md:text-base"
                >
